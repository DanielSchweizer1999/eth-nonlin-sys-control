# ETHZ Nonlinear Systems and Control

![action status](https://github.com/DanielSchweizer1999/eth-nonlin-sys-control/actions/workflows/build_deploy.yml/badge.svg)

This repository contains the LaTex source of the Nonlinear Systems and Control course summary.

A pre-build pdf file can be downloaded here:

- [eth-nonlin-sys-control-full.pdf](https://DanielSchweizer1999.github.io/eth-nonlin-sys-control/main_full.pdf)
- [eth-nonlin-sys-control.pdf (without examples)](https://DanielSchweizer1999.github.io/eth-nonlin-sys-control/main.pdf)
