...
\begin{align*}
    \boxed{\Dot{x} = f(x)}
\end{align*}
\textbf{Def}: A system is said to be \textbf{autonomous} or \textbf{time invariant} if the function $\Dot{x} = f(x)$ does not depend explicitly on $t$.\\
...
\begin{align*}
    \boxed{\Dot{x} = f(x) \approx f(x) \cdot \frac{\partial}{\partial x^T} = \begin{bmatrix}
                                                                                     \frac{\partial}{\partial x_1} f_1 & \dots  & \frac{\partial}{\partial x_n} f_1 \\
                                                                                     \vdots                            & \ddots & \vdots                            \\
                                                                                     \frac{\partial}{\partial x_1} f_m & \dots  & \frac{\partial}{\partial x_n} f_m
                                                                                 \end{bmatrix}}
\end{align*}
